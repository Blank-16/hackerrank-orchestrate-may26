...
class SupportAgent:
    ...
    def process_ticket(self, issue: str, subject: str, company: str):
        ...
        # 2. Determine company if missing
        ...
        # 5. LLM Generation & Verification Loop
        ...
        return self._escalation_response(f"Validation failed after retry: {retry_error}")
