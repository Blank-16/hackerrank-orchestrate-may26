...
class Retriever:
    ...
    def retrieve(self, query: str, target_company: str, top_k=10):
        ...
        # Fuses sparse and dense results without normalizing arbitrary scores
        fused_scores = {}
        k_rrf = 60
        ...
        # Escalates immediately if the top reranked document falls below semantic threshold
